...
public class SecurityListing {
   ...
   private static Map<String, String> parameters(Object obj) {
     ...
     public String toString() {
        ...
        String listing = "Name: "+ Name + newLine;
        listing += "Smb: " + Smb + newLine;
        listing += "ISIN " + ISIN + newLine;
        listing += "Type " + Type + newLine;
        listing += "SubType " + SubType + newLine;
        listing += "SubTypeDesc " + SubTypeDesc + newLine;
        listing += "SubId " + SubId + newLine;
        listing += "ETFType " + ETFType + newLine;
        return listing; 
     }
}